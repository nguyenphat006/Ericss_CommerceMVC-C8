...
public partial class EricssEcommerceContext : DbContext
{
    public EricssEcommerceContext()
    {
    }

    public EricssEcommerceContext(DbContextOptions<EricssEcommerceContext> options)
        : base(options)
    {
    }
...
//        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-5UAP4S99\\DANGPHAT;Initial Catalog=Ericss_Ecommerce;Integrated Security=True;Trust Server Certificate=True");
