...
namespace Ericss_CommerceMVC_C8.Controllers
{
    ...
    {
        private readonly EricssEcommerceContext _context;

        public HangHoasController(EricssEcommerceContext context)
        {
            _context = context;
        }
        ...
        {
            var ericssEcommerceContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await ericssEcommerceContext.ToListAsync());
        }
